  ...
  return (
    <BrowserRouter>
      <Switch>
        ...
        <Route exact path="/Faq" name="Faq Page" render={props => <Faq {...props} />} />
        ...
        <Route exact path="/BlogDetails" name="BlogDetails Page" render={props => <BlogDetails {...props} />} />
        <Route exact path="/ProductDescription" name="ProductDescription Page" render={props => <ProductDescription {...props} />} />
        <Route exact path="/ProductList" name="ProductList Page" render={props => <ProductList {...props} />} />
        <Route exact path="/Service" name="Service Page" render={props => <Service {...props} />} />
        <Route exact path="/CheckOut" name="CheckOut Page" render={props => <CheckOut {...props} />} />
        <Route exact path="/OrderDetails" name="OrderDetails Page" render={props => <OrderDetails {...props} />} />
        <Route exact path="/OrderStatus" name="OrderStatus Page" render={props => <OrderStatus {...props} />} />
        <Route exact path="/PrivacyPolicy" name="PrivacyPolicy Page" render={props => <PrivacyPolicy {...props} />} />
