  ...
  render() {
    ...
    return (
      ...
      <section className="faq_section" id="faq_section">
                        ...
                        <div key={index} className="faq_collapse_card">
                          <Card>
                            <Accordion.Toggle
                              ...
                              as={Card.Header}
                              className={data.status === "0" ? "faq_background_color " : "faq_background_color_active"}
                              eventKey={data.event_id}
                            >
                              <div className={data.status === "0" ? "faq_collapse faq_color " : "faq_collapse faq_active"}>
                                {data.name}
                                <i onClick={() => this.handleViewBtnClick(data.id)}
                                  className={data.status === "0" ? "fa fa-plus-circle faq_color" : "fa fa-minus-circle faq_active "} aria-hidden="true"></i>
                              </div>
                            </Accordion.Toggle>
            ...
            <Row>
              <Col md={6}>
                ...
                <div className="faq_form_padding">
                  <h3 class="">Ask about <span class="accent-color">Natureraise</span></h3>
                  <p>Temporibus autem quibusdam et aut officiis debitis is aut rerum necessitatibuse in saepes eveniet ut etes seo lage voluptates repudiandae sint et molestiae non mes for Creating futures through building pres Creating preservation etes from quibusdam barcelona.</p>
        ...
        <section className="faq_support_section section_padding_top_bottom" id="faq_support_section">
          <div className="auto-container">
            <Row>
              <Col md={12}>
                <div className="steps_work_content">
                    ...
                    <div className="faq_support_card">
                      ...
                      <div className="faq_support_icons">
                        <div className="faq_support_wrapper">
                          <img src={images.delivery} alt="Natureraise" className="contact_phone" />
                        </div>
                      ...
                      <div className="faq_support_title">
                        ...
                        <p>NatureRaise is among the world's leading renewable energy solutions provider that is revolutionising</p>
                      </div>
                    </div>
                  </Col>
