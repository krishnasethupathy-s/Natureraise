              ...
              <Col md={6} lg={5} className="padding_top_bottom">
                <div>
                  <div className="subtitle">
                    ...
                    <p>
                      For future, energy solar industry would definitely be the
                      top demand option due to its superior in terms of
                      availability, cost effectiveness, accessibility, capacity,
                      and efficiency compared to other renewable energy sources.
                      By overhauling the importance and requirements of solar to
                      create a solar tech company, Natureraise was formed in
                      2019. Natureraise is one of the foremost solar energy
                      companies in India having established its roots offline in
                      the industry in the year 2010.
                    </p>
                  </div>
              ...
              <Col md={12}>
                <div className="steps_work_content">
                  ...
                  <p>
                    ...
                    scheduling, manufacturing, services and spares, technology,
                    R&D, etc. are integrated to give a complete solutions
                    package.
                  </p>
                </div>
