...
export default class Service extends Component {
  render() {
    return (
      <section>
        <SectionHeader
          about_banner="service_banner"
          section_title="Service"
          section_subtitle="Service"
        />
        <div
          className="service_section section_padding_top_bottom"
          id="service_section"
        >
          <Sectionsubtitle
            title="what we offer"
          ...
          <div
            className="service_why section_padding_top_bottom"
            id="service_why"
          >
                ...
                <Row>
                  ...
                  <Col md={6}>
                    <div className="service_wrapper">
                      ...
                      <h3 className="service_wrapper_subtitle">
                        Save the Planet by Using Renewable Energy
                      </h3>

                      <p className="service_wrapper_description">
                        iRecco is among the world’s leading renewable energy
                        solutions provider that is revolutionising and
                        redefining the way sustainable energy sources are
                        harnessed across the world. Present in 18 countries
                        across Asia, Australia, Europe, Africa and the Americas,
                        Veztaz is powering a greener tomorrow.
                      </p>
                      <Row>
                        <Col md={6}>
          ...
          <div
            className="price_plan_section section_padding_top_bottom"
            id="price_plan_section"
          >
            <Sectionsubtitle
              title="pricing tables"
              subtitle="Choose Your Best Service"
              doublestring="pricing"
              description="All functions including supply chain, value chain, project scheduling, manufacturing, services and spares, technology, R&D, etc. are integrated to give a complete solutions package."
            />
